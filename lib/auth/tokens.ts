...
const ACCESS_SECRET = process.env.NEXT_PUBLIC_JWT_ACCESS_SECRET || 'dev-access-secret-change-in-production';
const REFRESH_SECRET = process.env.NEXT_PUBLIC_JWT_REFRESH_SECRET || 'dev-refresh-secret-change-in-production';
