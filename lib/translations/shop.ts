...
export const appointmentCopy = {
  ...
  bn: {
    ...
    details: [
      ...
      {
        label: 'ডাক্তারকে কী জানাতে চান?',
        ph: 'একটি ছোট নোট (ঐচ্ছিক)',
        textarea: true,
      },
    ],
...
export const shopCopy = {
  ...
  bn: {
    eyebrow: 'ক্লিনিকের শপ',
    title1: 'সুস্থতা,',
    titleEm: 'পরিচয়যুক্ত।',
    lead: 'ডাক্তারদের সুপারিশকৃত প্রতিদিনের স্বাস্থ্যের প্রয়োজনীয় পণ্য।',
    bag: 'কেনা পণ্য',
    items: 'টি পণ্য',
    ...
    products: 'টি পণ্য',
    search: 'পণ্য খুঁজুন',
    wishlistAria: 'প্রিয় তালিকায় যোগ করুন',
    addBtn: 'যোগ করুন',
    doctorPick: 'ডাক্তারের পছন্দ',
    ratingLine: '৪.৯',
    ratingSub: '· ৪২টি রোগীর রিভিউ',
    bagHeading: 'আপনার কেনা পণ্য',
    emptyBag: 'আপনার কেনা পণ্যের তালিকা খালি।',
    shopNow: 'পণ্য ব্রাউজ করুন',
    subtotal: 'উপমোট',
    delivery: 'বিতরণ',
    total: 'মোট',
...
export const checkoutCopy = {
  ...
  bn: {
    eyebrow: 'নিরাপদ অর্ডার সম্পূর্ণকরণ',
    title1: 'প্রায়',
    titleEm: 'শেষ।',
    deliveryHeading: 'বিতরণের তথ্য',
    deliveryFields: [
      { label: 'পুরো নাম', ph: 'আপনার নাম' },
      { label: 'ফোন নম্বর', ph: '+৮৮০' },
      { label: 'ইমেইল ঠিকানা', ph: 'you@example.com' },
      { label: 'শহর / এলাকা', ph: 'শহর' },
      { label: 'বিতরণ ঠিকানা', ph: 'ঠিকানা', textarea: true },
    ],
    paymentHeading: 'পেমেন্ট ব্যবস্থা',
    paymentOptions: ['ক্যাশ অন ডেলিভারি', 'মোবাইল ওয়ালেট', 'কার্ড পেমেন্ট'],
    summary: ['ডেইলি ব্যালেন্স প্রোবায়োটিক', 'বিতরণ ফি', 'মোট'],
    placeBtn: 'অর্ডার সম্পূর্ণ করুন',
  },
} as const;
...
export const successCopy = {
  ...
  bn: {
    eyebrow: 'অর্ডার সফলভাবে সম্পন্ন',
    title1: 'আমাদের উপর',
...
export const reviewsCopy = {
  ...
  bn: {
    ...
    rateLine: 'আপনার অভিজ্ঞতা মূল্যায়ন করুন',
  },
} as const;
