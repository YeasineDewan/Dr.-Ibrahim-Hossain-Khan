...
export const navCopy = {
  en: {
    navItems: ['Home', 'About', 'Skin & Hair Care', 'Infertility Care', 'Gallery', 'Chambers'],
    ...
    servicesSliderEyebrow2: 'Infertility & wellness',
    servicesSliderTitle2: 'Supporting your journey to parenthood.',
    servicesSliderCta2: 'Learn about infertility care',
    ...
    servicesCat2Desc: 'Integrative infertility support and family medicine.',
  ...
  bn: {
    navItems: ['হোম', 'পরিচিতি', 'ত্বক ও চুলের যত্ন', 'বন্ধ্যত্ব যত্ন', 'গ্যালারি', 'চেম্বার'],
    ...
    notice: [
      ...
      'নির্বাচিত কনসালটেশনের সাথে ফ্রি স্বাস্থ্য স্ক্রিনিং',
      'তিনটি চেম্বারে নতুন রোগীদের স্বা��তম',
    ],
    brandSub: 'ত্বক, যৌন রোগ ও ইন্টিগ্রেটিভ মেডিসিন বিশেষজ্ঞ',
    servicesDropdownLabel: 'সেবাসমূহ',
    servicesSliderEyebrow1: 'ত্বক ও চুলের যত্ন',
    servicesSliderTitle1: 'সুস্থ ত্বক, আত্মবিশ্বাসযুক্ত আপন।',
    servicesSliderCta1: 'ত্বক যত্ন আবিষ্কার করুন',
    servicesSliderSlug1: 'skin-hair-care',
    servicesSliderEyebrow2: 'গর্ভপ্রাপ্তি ও স্বাস্থ্য',
    servicesSliderTitle2: 'পিতৃত্বের প্রতি সহায়তা।',
    servicesSliderCta2: 'গর্ভপ্রাপ্তি সম্পর্কে জানুন',
    servicesSliderSlug2: 'infertility-care',
    servicesCat1Name: 'ত্বক ও চুলের যত্ন',
    servicesCat1Desc: 'ডার্মাটোলজি, ট্রিচোলজি এবং সৌন্দর্য চিকিৎসা।',
    servicesCat1To: 'সেবা',
    servicesCat2Name: 'বন্ধ্যত্ব যত্ন',
    servicesCat2Desc: 'ইন্টিগ্রেটিভ বন্ধ্যত্ব সহায়তা ও পরিবারিক চিকিৎসা।',
    servicesCat2To: 'সেবা',
    ...
    homePill: 'স্বাস্থ্যের ক্ষেত্রে বিশ্বস্ত চিকিৎসা',
