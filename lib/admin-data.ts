...
const sampleNotifications: Notification[] = [
  ...
  { id: 'N-002', type: 'patient', title: 'New patient registered', body: 'Olivia Park completed intake and is ready for review.', time: '15 min ago', read: false },
  { id: 'N-003', type: 'system', title: 'Lab results ready', body: 'Amara Mensah skin panel results uploaded for review.', time: '1 h ago', read: false },
  ...
  { id: 'N-007', type: 'patient', title: 'New review received', body: 'Mateo Diaz left a 2-star review for the skin care service.', time: '2 d ago', read: true },
]
...
const sampleActivity: ActivityItem[] = [
  ...
  { id: 'A-005', user: 'Front Desk', action: 'updated', target: 'Patient #DR-20489 follow-up', time: '2 h ago', ip: '102.176.55.32' },
...
const sampleGallery = [
  ...
  { id: 'G-005', url: 'https://images.unsplash.com/photo-1584982751601-97dcc096659c?auto=format&fit=crop&w=400&q=80', title: 'Consultation room', album: 'Clinic', date: '2026-05-22' },
