    ...
    <svg {...baseProps} style={style} className="illust-svg heartbeat-svg">
      ...
      <g opacity="0.15">
        {Array.from({ length: 6 }).map((_, i) => (
          <line key={`v${i}`} x1={i * 40} y1="0" x2={i * 40} y2="200" stroke="#14b8a6" strokeWidth="0.5"/>
        ))}
        {Array.from({ length: 6 }).map((_, i) => (
          <line key={`h${i}`} x1="0" y1={i * 40} x2="200" y2={i * 40} stroke="#14b8a6" strokeWidth="0.5"/>
        ))}
      </g>
      {/* glowing pulse rings */}
  ...
  return (
    <svg {...baseProps} style={style} className="illust-svg leaf-svg">
      ...
      <g className="leaf-3d leaf-1">
        ...
        <path d="M60,80 Q90,30 130,50 Q120,90 60,80 Z" fill="url(#leaf-fill-1)" filter="url(#lf-shadow)"/>
      ...
      <g className="leaf-3d leaf-2">
        <path d="M110,130 Q150,90 170,120 Q150,150 110,130 Z" fill="url(#leaf-fill-1)" filter="url(#lf-shadow)"/>
        <path d="M110,130 Q140,110 170,120" stroke="#fff" strokeWidth="0.8" fill="none" opacity="0.6"/>
      </g>
      {/* particles */}
...
export function FamilyArt({ style }: { style?: CSSProperties }) {
  return (
    <svg {...baseProps} style={style} className="illust-svg family-svg">
      ...
      {/* orbit around them */}
      <circle cx="100" cy="100" r="80" stroke="url(#fm)" strokeWidth="1" fill="none" opacity="0.3" className="orbit-dashed"/>
    </svg>
  )
}
  ...
  return (
    <svg {...baseProps} style={style} className="illust-svg stetho-svg">
      ...
      <g className="stetho-3d" filter="url(#st-shadow)">
        ...
        {/* tubes */}
        <path d="M60,48 C60,80 100,80 100,110" stroke="url(#st-tube)" strokeWidth="6" fill="none" strokeLinecap="round"/>
        <path d="M140,48 C140,80 100,80 100,110" stroke="url(#st-tube)" strokeWidth="6" fill="none" strokeLinecap="round"/>
        {/* main tube */}
        <path d="M100,110 L100,140" stroke="url(#st-tube)" strokeWidth="8" fill="none" strokeLinecap="round"/>
        {/* bell (chest piece) */}
        <circle cx="100" cy="160" r="22" fill="url(#st-bell)" className="bell"/>
        <circle cx="100" cy="160" r="14" fill="none" stroke="#0f172a" strokeWidth="1.5" opacity="0.5"/>
        <circle cx="94" cy="154" r="4" fill="#fff" opacity="0.6"/>
      </g>
      {/* pulse dots emanating */}
      <circle cx="100" cy="160" r="28" stroke="#14b8a6" strokeWidth="1.5" fill="none" className="bell-pulse bp-1"/>
      <circle cx="100" cy="160" r="38" stroke="#14b8a6" strokeWidth="1" fill="none" className="bell-pulse bp-2"/>
    </svg>
  )
}
  ...
  return (
    <svg {...baseProps} style={style} className={`illust-svg pill-svg ${className || ''}`}>
      ...
      <g className="pill-3d" transform="translate(100 100) rotate(-30)" filter="url(#pl-shadow)">
        ...
        <rect x="-60" y="-22" width="60" height="44" rx="22" fill="url(#pl-l)" className="pill-left"/>
        <rect x="0" y="-22" width="60" height="44" rx="22" fill="url(#pl-r)" className="pill-right"/>
        {/* highlight */}
  ...
  return (
    <svg {...baseProps} style={style} className="illust-svg cal-svg">
      ...
      <g className="cal-3d" filter="url(#cl-shadow)">
        ...
        <text x="100" y="105" textAnchor="middle" fill="#fff" fontSize="10" fontWeight="800" fontFamily="system-ui">18</text>
      </g>
    </svg>
  )
}
  ...
  return (
    <svg {...baseProps} style={style} className="illust-svg hg-svg">
      ...
      <g className="hg-3d">
        ...
        {/* frame */}
        <path d="M55,30 L145,30 L145,40 L110,95 L145,160 L145,170 L55,170 L55,160 L90,95 L55,40 Z" fill="url(#hg-frame)" stroke="#92400e" strokeWidth="2"/>
        {/* sand top */}
        ...
        {/* falling stream */}
        <line x1="100" y1="95" x2="100" y2="120" stroke="#f59e0b" strokeWidth="2" className="sand-stream"/>
      </g>
    </svg>
  )
}
  ...
  return (
    <svg {...baseProps} style={style} className="illust-svg doc-svg">
      ...
      <g className="doc-3d">
        ...
        {/* body / coat */}
        <path d="M55,170 L55,130 Q55,100 100,100 Q145,100 145,130 L145,170 Z" fill="url(#dc-coat)" stroke="#94a3b8" strokeWidth="1.5"/>
        {/* coat V */}
        <path d="M100,100 L80,140 L100,170 L120,140 Z" fill="#e2e8f0"/>
        {/* tie */}
        <path d="M100,108 L95,135 L100,150 L105,135 Z" fill="#0ea5e9"/>
        {/* stethoscope */}
        <path d="M75,120 Q70,140 90,145" stroke="#0f172a" strokeWidth="2.5" fill="none" strokeLinecap="round"/>
        <path d="M125,120 Q130,140 110,145" stroke="#0f172a" strokeWidth="2.5" fill="none" strokeLinecap="round"/>
        ...
        {/* hair */}
        <path d="M72,55 Q72,30 100,30 Q128,30 128,55 Q128,50 120,48 Q100,40 80,48 Q72,50 72,55 Z" fill="#1e293b"/>
        {/* eyes */}
        <ellipse cx="91" cy="65" rx="2" ry="3" fill="#0f172a"/>
        <ellipse cx="109" cy="65" rx="2" ry="3" fill="#0f172a"/>
        {/* smile */}
        <path d="M92,78 Q100,84 108,78" stroke="#0f172a" strokeWidth="2" fill="none" strokeLinecap="round"/>
        {/* blush */}
    ...
    <svg {...baseProps} style={style} className="illust-svg dna-svg">
      ...
      <g className="dna-3d">
        ...
        {Array.from({ length: 10 }).map((_, i) => {
          ...
          return (
            <g key={i}>
              <line x1={100 - 25} y1={y} x2={100 + 25} y2={y} stroke="#cbd5e1" strokeWidth="1.5" opacity="0.6"/>
        ...
        {/* backbone */}
        <path d="M75,20 Q100,40 75,60 Q100,80 75,100 Q100,120 75,140 Q100,160 75,180" stroke="url(#dn-a)" strokeWidth="2.5" fill="none" className="dna-strand-a"/>
        <path d="M125,20 Q100,40 125,60 Q100,80 125,100 Q100,120 125,140 Q100,160 125,180" stroke="url(#dn-b)" strokeWidth="2.5" fill="none" className="dna-strand-b"/>
      </g>
    </svg>
  )
}
  ...
  return (
    <svg {...baseProps} style={style} className="illust-svg chat-svg">
      ...
      <g className="chat-3d" filter="url(#ch-shadow)">
        ...
        <path d="M30,60 L30,130 Q30,145 45,145 L75,145 L80,165 L105,145 L155,145 Q170,145 170,130 L170,60 Q170,45 155,45 L45,45 Q30,45 30,60 Z" fill="url(#ch-bub)" stroke="#94a3b8" strokeWidth="1.5"/>
  ...
  return (
    <svg {...baseProps} style={style} className="illust-svg globe-svg">
      ...
      <g className="globe-3d">
        ...
        {/* meridians */}
        <ellipse cx="100" cy="100" rx="30" ry="70" stroke="#fff" strokeWidth="1" fill="none" opacity="0.5"/>
        <ellipse cx="100" cy="100" rx="60" ry="70" stroke="#fff" strokeWidth="1" fill="none" opacity="0.4"/>
        <line x1="100" y1="30" x2="100" y2="170" stroke="#fff" strokeWidth="1" opacity="0.5"/>
        {/* continents */}
        <path d="M70,70 Q80,60 95,65 Q100,75 90,80 Q80,85 70,80 Z" fill="#22c55e" className="continent c-1"/>
        <path d="M105,90 Q120,85 130,95 Q125,110 115,108 Q105,105 105,90 Z" fill="#22c55e" className="continent c-2"/>
        <path d="M75,120 Q90,115 95,125 Q90,135 80,132 Q72,128 75,120 Z" fill="#22c55e" className="continent c-3"/>
        {/* highlight */}
  ...
  return (
    <svg {...baseProps} style={style} className="illust-svg mappin-svg">
      ...
      <g className="mappin-3d">
        ...
        <path d="M20,100 Q60,80 100,110 T180,100" stroke="#94a3b8" strokeWidth="1" fill="none" opacity="0.4"/>
        <path d="M40,40 L60,60 M100,40 L120,60 M140,40 L160,60" stroke="#94a3b8" strokeWidth="0.5" opacity="0.4"/>
        {/* pin shadow */}
        <ellipse cx="100" cy="160" rx="14" ry="3" fill="#0f172a" opacity="0.2" className="pin-shadow"/>
        {/* pin */}
